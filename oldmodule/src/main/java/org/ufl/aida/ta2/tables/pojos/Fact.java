...
public class Fact implements IFact {
    ...
    private static final long serialVersionUID = -411829438;
    ...
    private Boolean iseventnegated;
    private Boolean iseventhedged;
    ...
    public Fact(IFact value) {
        ...
        this.isnegated = value.getIsnegated();
        this.ishedged = value.getIshedged();
        this.iseventnegated = value.getIseventnegated();
        this.iseventhedged = value.getIseventhedged();
    ...
    public Fact(
        ...
        Boolean isnegated,
        Boolean ishedged,
        Boolean iseventnegated,
        Boolean iseventhedged,
        ...
        this.iseventnegated = iseventnegated;
        this.iseventhedged = iseventhedged;
    ...
    public Boolean getIseventnegated() {
        return this.iseventnegated;
    }

    @Override
    public void setIseventnegated(Boolean iseventnegated) {
        this.iseventnegated = iseventnegated;
    }

    @Override
    public Boolean getIseventhedged() {
        return this.iseventhedged;
    }

    @Override
    public void setIseventhedged(Boolean iseventhedged) {
        this.iseventhedged = iseventhedged;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (scoreevent == null) {
            ...
            return false;
        if (isnegated == null) {
            if (other.isnegated != null)
                return false;
        }
        else if (!isnegated.equals(other.isnegated))
            return false;
        if (ishedged == null) {
            if (other.ishedged != null)
                return false;
        }
        else if (!ishedged.equals(other.ishedged))
            return false;
        if (iseventnegated == null) {
            if (other.iseventnegated != null)
                return false;
        }
        else if (!iseventnegated.equals(other.iseventnegated))
            return false;
        if (iseventhedged == null) {
            if (other.iseventhedged != null)
                return false;
        }
        else if (!iseventhedged.equals(other.iseventhedged))
            return false;
    ...
    public int hashCode() {
        ...
        result = prime * result + ((this.isnegated == null) ? 0 : this.isnegated.hashCode());
        result = prime * result + ((this.ishedged == null) ? 0 : this.ishedged.hashCode());
        result = prime * result + ((this.iseventnegated == null) ? 0 : this.iseventnegated.hashCode());
        result = prime * result + ((this.iseventhedged == null) ? 0 : this.iseventhedged.hashCode());
    ...
    public String toString() {
        ...
        sb.append(", ").append(isnegated);
        sb.append(", ").append(ishedged);
        sb.append(", ").append(iseventnegated);
        sb.append(", ").append(iseventhedged);
