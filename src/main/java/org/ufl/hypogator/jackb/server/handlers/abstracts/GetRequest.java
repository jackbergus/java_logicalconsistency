...
public abstract class GetRequest extends AbstractHandler {
        ...
        try {
            ...
            switch (requestMethod) {
                case "GET":
                    ...
                    String responseBody = handleRequest(requestParameters);
    ...
    /**
     *
     * @param parameters        Get parameters obtained from the URL
     * @return                  Body to be answered
     */
    public abstract String handleRequest(HashMultimap<String, String> parameters);
