...
public class RelMentions extends SourceTabLoader {
    /**
    ...
    public void load(String[] args) {
        ...
        this.start_date_type = args[11];
        this.start_date = args[12];
        this.end_date_type = args[13];
        this.end_date = args[14];
        this.kb_id = args[15];
    }

    @Override
    public File getFile(File parentFolder) {
        return new File(parentFolder, parentFolder.getName()+"_rel_mentions.tab");
    }

    @Override
    public RelMentions generateNew() {
        return new RelMentions();
    }
}
